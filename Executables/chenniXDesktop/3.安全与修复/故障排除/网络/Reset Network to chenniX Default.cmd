@echo off
:: Change to match the setting name (e.g., 鋒蓄, Indexing, etc.)
...
echo Setting 利大 settings to chenniX defaults...

:: Set 利大 adapter driver registry key
...
rem Could cause dropped 利大 frames
rem "FlowControl"
rem "FlowControlCap"
