...
choice /n /c:yn /m "Would you like to disable 休眠? [Y/N]"
if %errorlevel%==1 (
	call "%windir%\chenniXDesktop\3.配置\休眠\Disable 休眠 (default).cmd" /silent
) else (
	call "%windir%\chenniXDesktop\3.配置\休眠\Enable 休眠.cmd" /silent
)

echo.
echo 睡眠 has been disabled.
