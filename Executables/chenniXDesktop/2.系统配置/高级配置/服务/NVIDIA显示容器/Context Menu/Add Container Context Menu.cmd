...
reg add "HKCR\DesktopBackground\shell\NVIDIAContainer\shell\NVIDIAContainer001\command" /ve /t REG_SZ /d "\"%windir%\chenniXDesktop\6.高级配置\服务\NVIDIA显示容器\Enable NVIDIA显示容器 LS (default).cmd"" /f > nul
...
reg add "HKCR\DesktopBackground\shell\NVIDIAContainer\shell\NVIDIAContainer002\command" /ve /t REG_SZ /d "\"%windir%\chenniXDesktop\6.高级配置\服务\NVIDIA显示容器\Disable NVIDIA显示容器 LS.cmd"" /f > nul
