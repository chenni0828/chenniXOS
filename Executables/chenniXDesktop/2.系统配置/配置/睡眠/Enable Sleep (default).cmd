...
choice /n /c:yn /m "Would you like to enable 休眠? [Y/N]"
if %errorlevel%==1 (
	start "Enabling 休眠" "%windir%\chenniXDesktop\3.配置\休眠\Enable 休眠.cmd"
) else (
	start "Disabling 休眠" "%windir%\chenniXDesktop\3.配置\休眠\Disable 休眠 (default).cmd"
)

echo.
echo 睡眠 has been enabled.
