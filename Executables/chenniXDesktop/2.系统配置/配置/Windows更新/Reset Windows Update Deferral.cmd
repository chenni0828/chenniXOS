...
reg add "HKLM\SOFTWARE\chenniXOS\Services\%settingNameFeature%" /v days /t REG_DWORD /d 0 /f >nul
...
reg add "HKLM\SOFTWARE\chenniXOS\Services\%settingNameQuality%" /v days /t REG_DWORD /d 0 /f >nul
