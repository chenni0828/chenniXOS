...
(
    reg delete "HKCU\System\GameConfigStore" /v "GameDVR_DSE行为" /f
    reg add "HKCU\System\GameConfigStore" /v "GameDVR_DXGIHonorFSEWindowsCompatible" /t REG_DWORD /d "0" /f
    reg add "HKCU\System\GameConfigStore" /v "GameDVR_EFSEFeatureFlags" /t REG_DWORD /d "0" /f
    reg delete "HKCU\System\GameConfigStore" /v "GameDVR_FSE行为" /f
    reg add "HKCU\System\GameConfigStore" /v "GameDVR_FSE行为Mode" /t REG_DWORD /d "2" /f
    reg add "HKCU\System\GameConfigStore" /v "GameDVR_HonorUserFSE行为Mode" /t REG_DWORD /d "0" /f
...
echo.
echo FSO和游戏栏 have been enabled.
