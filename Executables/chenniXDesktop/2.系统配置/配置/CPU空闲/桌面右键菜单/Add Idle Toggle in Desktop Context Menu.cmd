...
reg add "HKEY_CLASSES_ROOT\DesktopBackground\Shell\CpuIdle" /v "MUIVerb" /d "CPU空闲" /f
...
reg add "HKEY_CLASSES_ROOT\DesktopBackground\Shell\CpuIdle\Shell\Disable Idle\Command" /d "cmd /c \"\"%%windir%%\\chenniXDesktop\\3. General Configuration\\CPU空闲\\Disable Idle.cmd\"\" /silent" /f
...
reg add "HKEY_CLASSES_ROOT\DesktopBackground\Shell\CpuIdle\Shell\Enable Idle\Command" /d "cmd /c \"\"%%windir%%\\chenniXDesktop\\3. General Configuration\\CPU空闲\\Enable Idle (default).cmd\"\" /silent" /f
