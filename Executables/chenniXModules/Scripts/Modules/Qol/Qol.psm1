...
function Set-chenniXTheme {
    ...
    reg add "HKCU\Software\Policies\Microsoft\Windows\Personalization" /v "ThemeFile" /t REG_SZ /d "%windir%\Resources\Themes\chenniX-dark.theme" /f
}
