...
# Duplicate Ultimate Performance power scheme, customize it and make it the chenniX power scheme
...
powercfg /changename scheme_current "chenniX Power Scheme" "Power scheme optimized for optimal latency and performance."
...
& "$windir\chenniXModules\Scripts\toggleDev.cmd" -Disable '@("ACPI Processor Aggregator", "Microsoft Windows Management Interface for ACPI")' | Out-Null
